...
export function ResumePreview({
  ...
  const templateStyles = {
    mit: {
      ...
      header: 'text-center border-b-2 border-primary pb-2 mb-4',
      fullName: 'text-3xl font-bold font-headline text-primary tracking-tight',
      contactInfo: 'flex justify-center items-center flex-wrap gap-x-4 gap-y-1 text-xs text-muted-foreground',
      sectionTitle: 'text-lg font-bold font-headline text-primary uppercase tracking-wider border-b border-primary pb-1 mb-2',
      entryTitle: 'font-bold',
      entrySubtitle: 'italic',
      entryDate: 'text-xs text-muted-foreground',
      skillsContainer: 'flex flex-wrap gap-2',
      skillBadge: 'bg-primary/10 text-primary px-2 py-0.5 rounded text-xs',
      descriptionList: 'list-disc pl-5 mt-1 space-y-1',
    },
    harvard: {
      container: 'font-serif text-sm',
      header: 'text-center mb-4',
      fullName: 'text-4xl font-bold font-headline text-foreground tracking-normal',
      contactInfo: 'flex justify-center items-center flex-wrap gap-x-4 gap-y-1 text-xs text-muted-foreground',
      sectionTitle: 'text-sm font-bold font-headline text-foreground uppercase tracking-widest border-b-2 border-foreground mb-2 mt-4',
      entryTitle: 'font-bold',
      entrySubtitle: 'text-muted-foreground',
      entryDate: 'font-bold text-xs',
      skillsContainer: 'columns-2 md:columns-3',
      skillBadge: '',
      descriptionList: 'list-disc pl-5 mt-1 space-y-1 text-muted-foreground',
    },
  };
